    ...
    <div class="flex -mx-4 items-center justify-between relative">
      <div class="pr-4 w-60 max-w-full">
        <a href="/" class="w-full flex items-center py-2">
          <img
            src="{{ url('/img/logo-onironote.png') }}"
            alt="logo"
          ...
          <img
            src="{{ url('/img/logo-onironote.png') }}"
            alt="logo"
            class="w-[48px] lg:w-[100px] hidden dark:inline-block"
          />
          <span class="text-xl xl:text-2xl font-bold text-[#0c7187] dark:text-white">Oniro Note</span>
        </a>
      </div>
